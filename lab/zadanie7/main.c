...
void wyswietl_menu_zadanie7() {
    printf("LACZANIE DWOCH JEDNOKIERUNKOWYCH LIST POSORTOWANYCHI(zad7)\n");
    ...
    printf("5 - polacz listy A i B (scal) (zadanie 7)\n");
...
void zadanie7() {
    /// dwie listy posortowane jednokierunkowe - scalanie list A i B
